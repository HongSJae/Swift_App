...
let Snames: Array<String> = ["완전딸기바나나",
                            "완전초코바나나",
                            "피스타치오빽스치노",
                            "카라멜빽스치노",
                            "베리크런치빽스치노",
                            ...
                            "원조빽스치노",
                            "민트초코빽스치노"]
let Sprices: Array<NSString> = ["BASIC : 3,000\nSOFT : 3,500",
                               "BASIC : 2,800\nSOFT : 3,300",
                               "BASIC : 4,500\nSOFT : 5,000",
                               "BASIC : 4,500\nSOFT : 5,000",
                               "BASIC : 4,000\nSOFT : 4,500",
                               ...
                               "BASIC : 3,000\nSOFT : 3,500",
                               "BASIC : 3,500\nSOFT : 4,000"]
let Simages: Array<String> = ["http://paikdabang.com/wp-content/uploads/2018/05/%EC%99%84%EC%A0%84%EB%94%B8%EB%B0%94.jpg",
...
let Smessages: Array<String> = ["상큼한 딸기와 달달한 바나나의 완전 시원한 만남!",

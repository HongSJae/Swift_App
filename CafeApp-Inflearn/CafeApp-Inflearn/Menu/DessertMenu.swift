...
let Denames: Array<String> = ["노말한소프트",
                            "옥수크림",
                            "사라다빵",
                            "호두크런치",
                            "빽엔나",
                            ...
                            "크리미단팥빵",
                            "계란사라다빵"]
let Deprices: Array<NSString> = ["1,500",
                               "2,500",
                               "2,000",
                               "3,000",
                               "HOT : 3,000\nICED : 3,500",
                               ...
                               "1,500",
                               "3,500"]
let Deimages: Array<String> = ["http://paikdabang.com/wp-content/uploads/2018/05/%EB%85%B8%EB%A7%90%ED%95%9C%EC%86%8C%ED%94%84%ED%8A%B8.jpg",
...
let Demessages: Array<String> = ["입안에서 부드럽게 사르륵 녹는 마성의 아이스크림",
